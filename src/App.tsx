        ...
        {isDT ? (
          <>
            <Section title="Platform">
              <NavItem id="platform_home" label="Overview" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="platform_tenants" label="Tenants" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem
                id="platform_remote_access"
                label="Remote Access"
                icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ"
              />
              <NavItem id="platform_health" label="System Health" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="platform_revenue" label="Revenue" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
            </Section>
          </>
        ) : (
          <>
            <Section title="Workspace">
              <NavItem id="dashboard" label="Dashboard" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="agents" label="AI Agents" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡" />
              <NavItem id="swarm" label="Swarm Monitor" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¡" />
              <NavItem id="insight" label="Insight Engine" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
            </Section>
            <Section title="Knowledge Hub">
              <NavItem id="hub_overview" label="Overview" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="hub_articles" label="Articles and Docs" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="hub_ingestion" label="Ingestion Pipeline" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ" />
              <NavItem id="hub_training" label="Team Training" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¡" />
              <NavItem id="hub_analytics" label="KB Analytics" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ»" />
            </Section>
            <Section title="Customer Portal">
              <NavItem id="portal_overview" label="Overview" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem
                id="portal_conversations"
                label="Conversations"
                icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ"
              />
              <NavItem id="portal_actions" label="Agent Actions" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="portal_approvals" label="Approvals" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="portal_tickets" label="Tickets" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem id="portal_settings" label="Portal Settings" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
            </Section>
            <Section title="Knowledge &amp; Data">
              <NavItem id="knowledge_data" label="Overview" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              <NavItem
              ...
              <NavItem
                ...
                icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ"
              />
              <NavItem id="knowledge_files" label="Imported Files" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤" />
            </Section>
            {isOwnerOrAdmin && (
              <Section title="Admin">
                <NavItem id="connectors" label="Data Connectors" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
                <NavItem id="integrations" label="Integrations" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¡" />
                <NavItem id="security" label="Security and RBAC" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ " />
                <NavItem id="settings" label="Settings" icon="ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ" />
              </Section>
            )}
          </>
        )}
...
const DashboardPage = ({
  ...
  const kpiData = [
    ...
    },
    {
      ...
      sub: dbStats ? `${dbStats.openConversations} open ÃÂÃÂÃÂÃÂ· ${dbStats.resolvedConversations} resolved` : 'Customers plus Staff',
      icon: 'ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ',
      color: 'blue',
      trend: '+18%',
    ...
    },
    {
      ...
      sub: dbStats ? `${dbStats.publishedArticles} published ÃÂÃÂÃÂÃÂ· ${dbStats.totalArticles - dbStats.publishedArticles} drafts` : '94% coverage score',
      icon: 'ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ',
      color: 'purple',
  ...
  const recentActivity = [
    ...
    },
    {
      time: '18m ago',
      agent: 'Support Agent',
      action: 'Escalated ticket T-9921 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ confidence below threshold',
      type: 'escalated',
      icon: '!',
    },
    {
    ...
    },
    {
      ...
      action: 'Flagged policy update in Q3 handbook ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ KB refresh triggered',
      type: 'flagged',
      icon: 'f',
    },
    {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Welcome back ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ here is what your AI workforce is doing right now
          </p>
        </div>
        <div className="flex items-center gap-2">
          {['24h', '7d', '30d'].map((r) => (
            ...
            {agentStatus.map((a, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-slate-500">
                    {a.tasks} tasks ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {a.accuracy}% acc
                  </div>
                </div>
                <div
...
const mockKnowledgeItems: KnowledgeItem[] = [
  ...
  {
    id: 'ki6',
    title: 'Release Notes v4.2 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Agent Enhancements',
    type: 'release_note',
    audience: 'Both',
    productId: 'p1',
    moduleId: 'm2',
  ...
  },
  {
    ...
    summary:
      'Complete reference for all 8 RBAC roles across DT Platform and Tenant tiers ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ what each role can access, configure, and execute.',
    author: 'Alex Rivera',
    version: '2.0',
  ...
  {
    id: 'ki11',
    title: 'Plan Upgrade Guide ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Enterprise Features',
    type: 'article',
    audience: 'Customer',
    productId: 'p1',
    moduleId: 'm4',
...
const defaultAgents: AgentDef[] = [
  ...
  },
  {
    ...
    name: 'Account Agent',
    description:
      'Handles account management requests ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ password resets, profile updates, access management, and 2FA. Operates with conservative confidence thresholds.',
    icon: 'A',
    category: 'Customer',
    status: 'active',
    capabilities: [
    ...
    <div className="flex-1 overflow-auto bg-slate-950 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Configure agents that assist customers and internal staff ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ with
      ...
      <div className="mb-6 bg-slate-900 border border-slate-800 rounded-xl p-4">
        <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-3">
          How Agents Work ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Agentic Pipeline
        </div>
      ...
      {selectedAgent && (
        ...
        >
              ...
              <div className="bg-slate-800 rounded-lg p-4">
                ...
                <label className="flex items-center gap-2 mb-3 cursor-pointer">
                  ...
                  <span className="text-slate-300 text-sm">
                    Enable RAG ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ inject retrieved KB context before reasoning
                  </span>
                </label>
          ...
          {configTab === 'pipeline' && (
            <div className="space-y-3">
              <div className="text-xs text-slate-400 mb-3">
                ...
                request ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ from retrieval through reasoning to response. Drag to
                reorder stages.
              </div>
          ...
          {configTab === 'actions' && (
            <div className="space-y-4">
              <div className="text-xs text-slate-400 mb-3">
                Define what this agent is permitted to do ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ read-only queries,
                write actions, or financial transactions ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ and whether each
          ...
          {configTab === 'knowledge' && (
            <div className="space-y-4">
              ...
              {/* Knowledge Sources ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ taxonomy picker */}
              <div className="bg-slate-800 rounded-lg p-4">
                <div className="text-xs text-slate-400 mb-3 font-semibold uppercase tracking-wide">
              ...
              {/* Data Connectors ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ field-level scope */}
              <div className="bg-slate-800 rounded-lg p-4">
                <div className="text-xs text-slate-400 mb-3 font-semibold uppercase tracking-wide">
                      ...
                      >
                        ...
                        {!isBound && (
                          <div className="ml-8 text-xs text-slate-600 mt-0.5">
                            {dc.objects.length} objects available ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ enable to
                  ...
                  {[
                    {
                      ...
                      title: 'How to Request a Refund',
                      breadcrumb:
                        'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Billing ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Invoices & Payments ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Refund Policy',
                      score: 0.94,
                    },
                    {
                      ...
                      breadcrumb:
                        'Customer ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Invoice ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº amount, status, lineItems',
                      score: 0.88,
                    },
                    {
                      ...
                      breadcrumb:
                        'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Billing & Subscriptions',
                      score: 0.72,
                    },
                  ].map((r, i) => (
                    <div
    ...
    return (
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">
            AI-powered knowledge for customers and internal staff ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ one source
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Connect data sources ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ content is automatically chunked, embedded,
        ...
        <div className="mt-6 bg-slate-900 border border-slate-800 rounded-xl p-5">
          ...
          <div className="space-y-2">
            {[
              'Zendesk: 42 new tickets ingested and embedded ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 2 min ago',
              'Confluence: 8 pages updated, KB refresh triggered ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 12 min ago',
              'Google Drive: Policy doc v3.2 detected, diff processed ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 1 hr ago',
              'PDF Upload: Q3 Training Manual fully indexed 124 chunks ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 3 hr ago',
              'GitHub: 3 README files changed, embeddings updated ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 1 day ago',
            ].map((log, i) => (
    ...
    return (
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">
            AI-powered training modules built from your knowledge base ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ track
            staff completion
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      ? [
          {
            title: 'How to Request a Refund',
            breadcrumb:
              'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Billing ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Invoices ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Refund Policy',
            connector: null,
            score: 0.94,
            fresh: 98,
          },
          {
            title: 'Understanding Your Invoice',
            breadcrumb:
              'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Billing ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Invoices ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Invoice Downloads',
            connector: null,
            score: 0.88,
            fresh: 95,
          },
          {
            title: 'Invoice #inv_2026_0621',
            breadcrumb:
              'Stripe Billing ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Invoice ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº amount, status, periodStart, lineItems',
      ...
      ? [
          {
            title: 'Setting Up Two-Factor Authentication',
            breadcrumb:
              'Customer Portal ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Self-Service ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Password & Security ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº 2FA',
            connector: null,
            score: 0.96,
            fresh: 99,
          },
          {
            title: 'RBAC Roles and Permissions Reference',
            breadcrumb:
              'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Getting Started ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Onboarding ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Workspace Config',
            connector: null,
            score: 0.81,
            fresh: 96,
          },
          {
            ...
            breadcrumb: 'Salesforce CRM ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Contact ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº id, email, lastActivity',
      ...
      : [
          {
            title: 'Agent Pipeline Design Best Practices',
            breadcrumb:
              'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Agent Management ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Configuration ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Pipeline Design',
            connector: null,
            score: 0.89,
            fresh: 100,
          },
          {
            ...
            breadcrumb:
              'DreamTeam Platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Agent Management ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Configuration ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº LLM Model Selection',
            connector: null,
            score: 0.83,
            fresh: 100,
          },
          {
            ...
            breadcrumb: 'Imported File ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº Integrations & APIs ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº API Reference',
        ...
        prev.map((s, i) =>
          i === 0
            ? {
                ...s,
                status: 'done',
                detail: 'Routed to ' + chosenAgent + ' ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ confidence 97%',
                confidence: 97,
                duration: 120,
              }
            : i === 1
          ...
          i === 1
            ? {
                ...
                detail:
                  'Retrieved ' +
                  kbChunks.length +
                  ' sources ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ' +
                  kbChunks
                    .map(
                      (c) =>
    ...
    return (
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">
            AI agents serve your customers 24/7 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ answering questions, resolving
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              AI-handled customer conversations ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ live and historical
            </p>
          </div>
          <div className="flex gap-1 bg-slate-800 rounded-lg p-1">
            ...
            >
              ...
              <div className="text-right flex-shrink-0">
                ...
                <div className="text-xs text-slate-600 mt-0.5">
                  {conv.messages} msgs ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {conv.time}
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex flex-col">
          ...
          {traceVisible && traceSteps.length > 0 && (
            <div className="mb-4 bg-slate-950 border border-slate-700 rounded-xl p-3">
              <div className="text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wide">
                Agent Pipeline ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ {agentUsed}
              </div>
              <div className="space-y-1.5">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="Ask anything ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ billing, access, product..."
    ...
    return (
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">
            Configure what actions agents can perform on behalf of customers ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Human-in-the-loop ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ review agent actions that exceed confidence or
              risk thresholds
            </p>
          </div>
              ...
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <div className="text-xs text-slate-400">
                    Customer:{' '}
                    <span className="text-white">{item.customer}</span> ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ·{' '}
                    {item.email}
                  </div>
                  <div className="text-xs text-slate-400 mt-0.5">
                    Requested by:{' '}
                    <span className="text-white">{item.agent}</span> ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ·{' '}
                    {item.requestedAt}
                  </div>
                </div>
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Escalated issues requiring human review ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ AI continues to assist
              in context
            </p>
          </div>
          <button
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {models.map((m) => (
              ...
              >
                ...
                <div className="text-xs text-slate-600 mt-1">
                  {m.tokens} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {m.best}
                </div>
              </div>
            ))}
          </div>
...
const SwarmPage = ({ tenant }: { tenant?: Tenant }) => {
  ...
  const liveEvents = [
    ...
    'Compliance Agent flagged policy change ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ KB refresh triggered',
...
const SecurityPage = ({
  ...
  const auditLogs = [
    ...
    },
    {
      ...
      user: 'Support Agent',
      action:
        'Attempted password reset for customer James Liu ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ awaiting approval',
      type: 'agent_action',
      severity: 'warn',
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            },
            {
              name: 'HIPAA',
              status: 'available',
              desc: 'Healthcare data protection ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ available for healthcare tenants',
              cert: 'BAA available on request',
            },
            {
              name: 'PCI DSS',
              status: 'partial',
              desc: 'Payment card industry compliance ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Level 2 SAQ-D',
...
const KnowledgeDataPage = ({
  ...
  const getTaxBreadcrumb = (item: KnowledgeItem) => {
    ...
    return [prod?.label, mod?.label, sec?.label, sub?.label]
      .filter(Boolean)
      .join(' ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº ');
  };
    ...
    return (
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">
            Centralised knowledge taxonomy, connector registry, and file store ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Field-level permissions for every connector bound to an agent ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-slate-500">
                      Synced {dc.lastSync} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {dc.syncFrequency} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ·{' '}
                      {dc.recordCount.toLocaleString()} records ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ·{' '}
                      {dc.objects.length} objects ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {boundAgents} agent
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Files uploaded or synced from storage connectors ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ parsed,
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-slate-600 text-xs">
                            {file.size} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {file.uploadedBy}
                          </div>
                        </div>
                      </div>
                    </td>
    ...
    <div className="flex-1 overflow-auto bg-slate-950 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Connect databases and data warehouses ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ agents can query and act on
            live data
          </p>
        </div>
        <button
    ...
    return (
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">
            DreamTeam AI ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Master control centre for all tenants and system
            health
          </p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                event:
                  'Hooli Technologies exceeded 80% token limit ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ warning sent',
                time: '4 hr ago',
                type: 'warn',
              },
              {
                event: 'Pied Piper account suspended ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ payment failure',
                time: '1 day ago',
                type: 'error',
              },
              {
      ...
      <div className="flex-1 overflow-auto bg-slate-950 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Manage all client workspaces ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ view, configure, and support
              tenants
            </p>
          </div>
        ...
        {selectedTenant && (
          <Modal
            title={selectedTenant.name + ' ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Detail'}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-xs text-slate-400">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">Yes ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ visible to tenant</span>
                </div>
                <div className="flex justify-between">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">
                    {svc.latency} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· {svc.uptime} uptime
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-5">
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Customise your branded AI platform ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ your customers and staff
                will see this
              </p>
            </div>
            <div className="space-y-4">
        ...
        return (
          <div className="space-y-5">
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Upload documents or write articles ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ the AI uses this to answer
                queries
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3">
        ...
        return (
          <div className="space-y-5">
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Choose which agents to deploy ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ each serves customers or staff
              </p>
            </div>
            <div className="space-y-3">
              {[
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="text-indigo-200 text-sm leading-relaxed mb-8">
            ...
            and internal staff equally ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ with full audit trails and
        ...
        <div className="max-w-sm mx-auto w-full">
          ...
          <div className="border-t border-slate-800 pt-5">
            <p className="text-xs text-slate-500 mb-3">
              Demo accounts ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ click to log in instantly:
            </p>
            <div className="space-y-4">
...
function App() {
  ...
  // ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Supabase real data ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
  ...
  // ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Load Supabase data on login ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
  useEffect(() => {
    let _cleanup = false;
    (async () => {
      try {
