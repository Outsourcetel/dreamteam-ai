...
const MyAccountBadge = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2 pr-1 rounded-lg hover:bg-slate-800 transition-colors py-1"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-slate-800 border border-slate-600 rounded-xl shadow-2xl overflow-hidden z-40">
          ...
          <button
            ...
            className="w-full text-left px-3 py-2 text-xs text-rose-400 hover:bg-slate-700 transition-colors"
          >
            Sign out
          </button>
        </div>
