    ...
    <div className="bg-dt-card border border-dt-border rounded-xl p-5">
      <div className="flex items-start justify-between gap-4 flex-wrap mb-1">
        ...
        {!loading && totalAssigned === 0 && (
          <span className="text-[11px] px-2 py-0.5 rounded-full bg-dt-warn-soft text-dt-warn">Nobody assigned</span>
        )}
      </div>
      ...
      {error && (
        <div className="mb-4 rounded-lg border border-dt-danger-border bg-dt-danger-soft px-3 py-2 text-xs text-dt-danger">
          {error}
        </div>
      )}
            ...
            return (
              <div key={rel.key} className="border-t border-dt-border pt-3 first:border-t-0 first:pt-0">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  {mine.length === 0 && (
                    <span className="text-xs text-dt-warn">No {rel.label.toLowerCase()} named</span>
                  )}
                </div>
