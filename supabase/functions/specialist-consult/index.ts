...
serve(async (req) => {
  ...
  try {
    ...
    // Everything else this endpoint used to serve — the human specialist
    // consult, simulate_inquiry, mcp_test and the scribe desk — went with the
    // specialist role itself. Specialists were absorbed into digital_employees
    // (migrations 208/211) and every remaining is_specialist row is disabled;
    // a DE consults another DE now, inside runResolveInquiry. mcp_test was
    // already superseded by the mcp-client function.
