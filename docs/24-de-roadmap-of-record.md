...
- **GI-9 — Real certification. ⏳ IN PROGRESS.** Route the cert exam through the semantic `eval-judge` (retire fragment-match), make certification mandatory-before-autonomy (today an uncertified DE runs ungated).
